...
const Accueil = () => {
  ...
  const handleGetLocation = (ville, plante) => {
    ...
    fetch(url)
      ...
      console.log('Ville affiché : ' + ville)
    setMapURL(
      `https://maps.google.com/maps?q=${ville}&t=&z=13&ie=UTF8&iwloc=&output=embed`
    );
    ...
    return (
      <>
        ...
        <div className="animated-div">
          ...
          <div>
            <button
              className="btn btn-outline-success my-2 my-sm-10"
              onClick={handleClick}
            >
              Ajouter sa plante
            </button>
          ...
          <div>
            <div className="PlanteBrique">
              {filteredPlantes.map((plante) => (
                <div
                  className="PlanteBriqueInside card"
                ...
                >
                  ...
                  />
                  <button
                    className="positionLocalisation"
                    data-toggle="modal"
                    onClick={() => {
                      handleGetLocation(plante.localisation, plante);
                    }}
                  >
                    <img
    ...
    return (
      <>
        <div className="animated-div">
          ...
          {isVisible && <AjoutPlante setIsVisible={setIsVisible}></AjoutPlante>}
        </div>
      </>
    );
  }
